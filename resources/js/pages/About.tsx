      ...
      <div className="container">
        <div className="story-grid">
          ...
          <div className="story-body">
            ...
            <p>
              Dari garasi di Solo, kami memulai dengan 12 hot desk dan 1 ruang meeting.
...
/* ---- Values ---- */
interface Value { n: string; icon: ReactNode; t: string; d: string; }
...
/* ---- Timeline ---- */
interface TimelineEvent { y: string; t: string; d: string; }

function AboutTimeline() {
  const events: TimelineEvent[] = [
    { y: "2023", t: "Awal Mula", d: "Kaspa Space berdiri di Solo dengan 12 hot desk dan 1 meeting room." },
...
/* ---- Team ---- */
interface TeamMember { name: string; role: string; img: string; }
...
function AboutLocations() {
  const { data: apiLocs } = useApiGet<ApiLocation[]>(
    () => apiFetch<ApiLocation[]>('/api/locations')
  );

  const locs = apiLocs?.length
    ? apiLocs.map(l => ({
        ...l,
        hours: l.days_display
          ? `${l.days_display}, ${l.hours_display}`
          : l.hours_display,
      }))
    : LOCATIONS_DATA;

  const branchCount = locs.length;
  const cityCount   = new Set(locs.map(l => l.city)).size;
  const headingText = `${branchCount} Cabang, ${cityCount} Kota`;
      ...
      <div className="container">
        <div className="locations-head">
          <div>
            ...
            <h2 className="section-title"><em>{headingText}</em></h2>
          </div>
          <Link className="btn btn-ghost" to="/kontak">Lihat di Peta <Icon.Arrow /></Link>
        </div>
            ...
            <div key={i} className="location-card">
              ...
              <div className="location-body">
                ...
                <div className="location-actions">
                  ...
                  <Link className="btn btn-primary" to="/coworking">Booking</Link>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="cta-card">
          <div>
            ...
            <div className="cta-actions">
              <Link className="btn btn-primary" to="/coworking">Booking Tour Gratis <Icon.Arrow /></Link>
              <Link className="btn btn-ghost" to="/kontak">Hubungi Kami</Link>
            </div>
          </div>
